...
class ProjectBudget(Base, TimestampMixin, TenantMixin):
...
class ProjectPhase(Base, TimestampMixin, TenantMixin):
...
class ProjectAssignment(Base, TimestampMixin, TenantMixin):
...
class DailySiteReport(Base, TimestampMixin, TenantMixin):
...
class MaterialDelivery(Base, TimestampMixin, TenantMixin):
...
class SalaryPayment(Base, TimestampMixin, TenantMixin):
